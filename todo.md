...
- [x] Add Changelog tab to app to display version history
- [x] Fix nested anchor tag error in footer (Link component already renders <a>, don't wrap another <a> inside)
